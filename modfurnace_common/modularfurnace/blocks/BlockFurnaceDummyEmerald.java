...
public class BlockFurnaceDummyEmerald extends BlockContainer


{
    public BlockFurnaceDummyEmerald(int blockId)
    {
        
        super(blockId, Material.rock);
        
        setUnlocalizedName("blockFurnaceDummyEmerald");
    ...
    public void registerIcons(IconRegister iconRegister)
    {
        ...
        blockIcon = iconRegister.registerIcon("emerald_block");
    	else
