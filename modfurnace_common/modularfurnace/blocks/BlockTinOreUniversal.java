...
public class BlockTinOreUniversal extends Block {
	private final String setInfo;
	private final String setColor;


	public BlockTinOreUniversal(int par1) {
		super(par1, Material.rock);
		setUnlocalizedName("tinOreUniversal");
	...
	{
		blockIcon = iconRegister.registerIcon("modularOreTin");
	}
