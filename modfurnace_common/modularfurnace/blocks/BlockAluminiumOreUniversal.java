...
public class BlockAluminiumOreUniversal extends Block {
	private final String setInfo;
	private final String setColor;


	public BlockAluminiumOreUniversal(int par1) {
		super(par1, Material.rock);
		setUnlocalizedName("aluminiumOreUniversal");
	...
	{
		blockIcon = iconRegister.registerIcon("modularOreAluminium");
	}
