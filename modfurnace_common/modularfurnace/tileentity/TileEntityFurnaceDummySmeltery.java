...
public class TileEntityFurnaceDummySmeltery extends TileEntity implements ISidedInventory
{
	public int slot = 4;
	TileEntityFurnaceCoreSmeltery tileEntityCore;
	int coreX;
	int coreY;
	int coreZ;
	
	public TileEntityFurnaceDummySmeltery()
	{
	}
	
	public void setCore(TileEntityFurnaceCoreSmeltery core)
	{
		coreX = core.xCoord;
		coreY = core.yCoord;
		coreZ = core.zCoord;
	...
	public TileEntityFurnaceCoreSmeltery getCore()
	{
		if(tileEntityCore == null)
			tileEntityCore = (TileEntityFurnaceCoreSmeltery)worldObj.getBlockTileEntity(coreX, coreY, coreZ);
