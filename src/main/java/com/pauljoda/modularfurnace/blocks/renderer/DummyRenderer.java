package com.pauljoda.modularfurnace.blocks.renderer;
...
public class DummyRenderer implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
		...
		if(ClientProxy.renderPass == 0)
		{
			...
			if(block == BlockManager.furnaceDummyRedstone)
			...
			if(block == BlockManager.furnaceDummyDiamond)
				renderer.renderStandardBlock(Blocks.diamond_block, x, y, z);

			if(block == BlockManager.furnaceDummyEmerald)
				renderer.renderStandardBlock(Blocks.emerald_block, x, y, z);

			if(block == BlockManager.furnaceDummyGlowStone)
			...
			if(block == BlockManager.crafterActive || block == BlockManager.crafterInactive)
